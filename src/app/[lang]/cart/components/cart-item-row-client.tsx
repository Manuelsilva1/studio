...
export function CartItemRowClient({ item, lang }: CartItemRowClientProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between py-4 border-b last:border-b-0">
      <div className="flex items-center space-x-4 mb-4 sm:mb-0">
        ...
        <div>
          <Link href={`/${lang}/books/${item.book.id}`} className="hover:text-primary transition-colors">
